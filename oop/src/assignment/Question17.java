...
public class Question17 {
	public static void main(String[] args) {
		...
		if (num1 % 2 == 0 || num1 % 5 == 0 || num1 % 8 == 0) {
			System.out.println(num1 + "은(는) 2나 5나 6의 배수");
		}
		
		if (num2 % 2 == 0 || num2 % 5 == 0 || num2 % 8 == 0) {
			System.out.println(num2 + "은(는) 2나 5나 6의 배수");
		}
		
		if (num3 % 2 == 0 || num3 % 5 == 0 || num3 % 8 == 0) {
			System.out.println(num3 + "은(는) 2나 5나 6의 배수");
		}
		
		if (num4 % 2 == 0 || num4 % 5 == 0 || num4 % 8 == 0) {
			System.out.println(num4 + "은(는) 2나 5나 6의 배수");
		}
		
		if (num5 % 2 == 0 || num5 % 5 == 0 || num5 % 8 == 0) {
			System.out.println(num5 + "은(는) 2나 5나 6의 배수");
		}
