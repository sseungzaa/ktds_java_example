...
public class AAAmemo {
	...
	public static void main(String[] args) {
		...
		// App Interface? Class?
			...
			게시판은 다음 기능을 제공합니다.
			// 인터페이스에 싹 다 만든다?
				게시글 목록 조회 // SearchPostList
				게시글 내용 조회 // SearchPost
				게시글 등록 // (Add)Post
				게시글 수정 // EditPost
				게시글 삭제 //DeletePost
				댓글 등록 // (Add)Comment
			...
			하나의 게시글은 다음 정보를 포함합니다.
				게시글 인덱스 번호 // PostIdx
				게시글 제목 // PostHeadline
				게시글 작성 날짜(연월일) // PostDate
				게시글 작성 시간(시분초) // PostTime 합치면 그냥 PostDateTime
				게시글 작성자 이름 // PostUserName
				게시글 내용 // PostBody
			...
			하나의 댓글은 다음 정보를 포함합니다.
				...
				댓글 내용 // CommentBody
				댓글 작성자 이름 // CommentUserName
				댓글 작성 날짜(연월일) // CommentDate
				댓글 작성 시간(시분초) // CommentTime 합치면 그냥 CommentDateTime
